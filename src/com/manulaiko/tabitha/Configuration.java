 ...
 * parameter the name of the configuration file, the returning object is an instance
 * of `com.manulaiko.tabitha.configuration.IConfiguration` and is instanced
...
public class Configuration {
     ...
     * @throws IOException           If couldn't read configuration file.
     */
    public static PropertiesConfiguration loadProperties(String path) throws FileNotFoundException, IOException,
            Exception {
